...
\vpara{Motif} Graph motifs are an important local property which are defined as recurrent and statistically significant subgraphs or patterns. Many researchers have studied graph motifs. 
...
\vpara{Generating random graph} Generating random graphs is an important problem in social network analysis. 
