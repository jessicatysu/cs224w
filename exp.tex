...
\vpara{Data sets.} We evaluate the proposed method on nine different kinds of networks: aut-as19971108, aut-as19990628, cit-scimet, col-ca-GrQc, col-netscience, met-HI, ppi-ppiall, ppi-ppiapms and pwr-power.
Table \ref{tb:statistics} lists statistics of the nine networks. 

\vpara{Evaluation metrics.} To quantitatively evaluate the proposed model, we consider using the average relative error to measure our performance:
